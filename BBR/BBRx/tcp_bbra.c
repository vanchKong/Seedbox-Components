 ...
 */
static const int bbr_startup_pacing_gain = BBR_UNIT * 390 / 100 + 1;
...
static const int bbr_pacing_gain[] = {
	BBR_UNIT * 6 / 4,	/* UP: probe for more available bw */
	BBR_UNIT * 91 / 100,	/* DOWN: drain queue and/or yield bw */
	BBR_UNIT * 6 / 4,		/* CRUISE: try to use pipe w/ some headroom */
	BBR_UNIT * 6 / 4,		/* REFILL: refill pipe to estimated 100% */
};
...
MODULE_DESCRIPTION("TCP BBRa MOD @2025.04.27 12:00 (Bottleneck Bandwidth and RTT)");
